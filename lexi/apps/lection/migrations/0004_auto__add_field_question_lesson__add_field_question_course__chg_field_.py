...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.lesson'
        db.add_column(u'lection_question', 'lesson',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lection.Lesson']),
                      keep_default=False)

        # Adding field 'Question.course'
        db.add_column(u'lection_question', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lection.Course']),
                      keep_default=False)


        # Changing field 'Question.unit'
        db.alter_column(u'lection_question', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lection.Unit']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Question.unit'
        db.alter_column(u'lection_question', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lection.Unit'], null=True))
