...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Unit.sequence'
        db.delete_column(u'lection_unit', 'sequence')

        # Adding field 'Unit.position'
        db.add_column(u'lection_unit', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Unit.sequence'
        db.add_column(u'lection_unit', 'sequence',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Unit.position'
        db.delete_column(u'lection_unit', 'position')
