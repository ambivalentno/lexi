...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lection_question', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.is_active'
        db.add_column(u'lection_course', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unit.is_active'
        db.add_column(u'lection_unit', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Lesson.is_active'
        db.add_column(u'lection_lesson', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'lection_question', 'is_active')

        # Deleting field 'Course.is_active'
        db.delete_column(u'lection_course', 'is_active')

        # Deleting field 'Unit.is_active'
        db.delete_column(u'lection_unit', 'is_active')

        # Deleting field 'Lesson.is_active'
        db.delete_column(u'lection_lesson', 'is_active')
