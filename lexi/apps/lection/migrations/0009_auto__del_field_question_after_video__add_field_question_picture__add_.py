...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.after_video'
        db.delete_column(u'lection_question', 'after_video')

        # Adding field 'Question.picture'
        db.add_column(u'lection_question', 'picture',
                      self.gf('users.utils.thumbs.ImageWithThumbsField')(blank=True, max_length=100, null=True, sizes=((640, 468), (1024, 768), (400, 300))),
                      keep_default=False)

        # Adding field 'Lesson.notes'
        db.add_column(u'lection_lesson', 'notes',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Question.after_video'
        db.add_column(u'lection_question', 'after_video',
                      self.gf('embed_video.fields.EmbedVideoField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Question.picture'
        db.delete_column(u'lection_question', 'picture')

        # Deleting field 'Lesson.notes'
        db.delete_column(u'lection_lesson', 'notes')
